...
public class all_in_one_interface_boundary extends StarMacro {
  ...
  private void execute0() {
    ...
    f = new File("/D:/Jalori/RobinSequence/Subj14/new_interpolation/single_dt_csvs/");
    paths = f.list();
    ...
    */
    ...
    while(period_count <= n_periods-1){
      ...
      String path = paths[period_count];
      simulation_0.println(path);
      ...
      */
      ...
      if (period_count != 0){
          ...
          // Get the correct file table 
          String table_path_to_delete = paths[period_count-1];
