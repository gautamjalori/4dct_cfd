...
public class read_control_points_target_pos extends StarMacro {
  ...
  private void execute0() {
    ...
    targetPositionProfile_0.getMethod(TimeXyzTabularVectorProfileMethod.class).setTable(fileTable_100);
